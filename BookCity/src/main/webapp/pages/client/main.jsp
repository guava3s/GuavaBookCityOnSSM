    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".book_cond :button").click(function () {
                ...
                var max = $("input[name='max']").val();
                //请求BookClientServlet
                location = "books/1?max=" + max + "&min=" + min;
            });
        });
    </script>
</head>
...
<div id="main">
    <div id="book">
        <div class="book_cond">
            价格：<input type="text" name="min" value=""> 元 - <input type="text" name="max"
                                                                  value="">
            元
    ...
    <div id="page_nav">
        ...
        <c:if test="${Page.currentPage>1 }">
            <a href="books/${Page.currentPage-1 }">上一页</a>
        </c:if>
        <c:if test="${Page.currentPage < Page.totalPage }">
            <a href="books/${Page.currentPage+1 }">下一页</a>
        </c:if>
        <a href="books/${Page.totalPage}">末页</a>
